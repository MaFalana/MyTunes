<?php
	...
	if ( isset($_SESSION['userId']) )
	{
		...
		echo '<div class="searchHeader">Liked Songs</div>';

		echo '<form action="likes.php" method="post" class="searchSection">'; //need to change action to likes
	...
	if ( isset($_POST['like']) )
	{
		...
		$selectedSong = $_POST['id'];
		
		echo $selectedSong;

		$lib->likeASong($selectedSong); //pretty much unlikes a song
