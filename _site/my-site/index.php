				...
				<div class="subset">
					<form action="index.php" method="post">
						...
						<?php
							...
							{
								//echo '<div class="subsetTitle" name="LOGOUT">Log out</div>';
								echo '<input class="subsetTitle" name= "LOGOUT" type="submit" value="Log out">';
							}
							else
							{
								echo '<input class="subsetTitle" name= "LOGIN" type="submit" value="Login">';
							}
						?>
